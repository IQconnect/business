<section class="section">
    <div class="container">
      ...
      <h2 class="headline">
        koszt zatrudnienia<br>
        doradcy biznesowego
      </h2>
      <div class="text section__desc pb-0 prices">
        <p>
          Stałe zatrudnienie konsultantów różnych specjalności  jest  po pierwsze drogim rozwiązaniem, a po drugie nie sprawdza się w obecnych szybko zmieniających się czasach. Dlatego też coraz powszechniejszy staje się outsourcing doradcy zewnętrznego, który polega na współpracy w oparciu o umowę ramową (często liczba godzin jest zbliżona do liczby godzin pełnego etatu), co jest  z pewnością częściej wykorzystywane  przez firmy dysponujące większymi budżetami lub nawiązanie współpracy opartej na godzinowym modelu rozliczeniowym lub bardziej korzystnym i przewidywalnym dla obu stron Klient – doradca modelu „pakietowym
        </p>
        <div class="prices__models">
          <div class="prices__model accordion">
            <div class="accordion__header">
              <div>
                <span class="title title--small is-bold is-secondary">Model godzinowy</span>
          ...
          <div class="prices__model accordion">
            <div class="accordion__header">
              <div>
                <span class="title title--small is-bold is-secondary">Model pakietowy</span>
                <h3 class="title title--smedium">
